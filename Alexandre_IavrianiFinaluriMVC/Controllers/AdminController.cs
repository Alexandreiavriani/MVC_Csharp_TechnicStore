...
using Alexandre_IavrianiFinaluriMVC.Models;
using PagedList;

namespace Alexandre_IavrianiFinaluriMVC.Controllers
{
    public class AdminController : Controller
    {
        ...
        //{
        //    tbl_category c = db.tbl_category.Where(x => x.cat_id == id).FirstOrDefault();
        //    return View(c);

        //}

        //[HttpPost]
        //public ActionResult Edit(tbl_category cvm, HttpPostedFileBase imgfile)
        //{

        //    tbl_category c = db.tbl_category.Where(x => x.cat_id == cvm.cat_id).FirstOrDefault();
        //    string path = uploadimgfile(imgfile);
        //    if (path.Equals("-1"))
        //    {
        //        ViewBag.error = "Image could not be uploaded....";
